var fs = require('fs'),
    ...
    gdsComponentJson = require('./gdsComponents.json');
...
gdsComponentJson.map(function(component) {
    ...
    */
    ...
    fs.writeFile('./output/gds-sublime/' + component.tabTrigger + '.sublime-snippet', sublimeSnippet, function(err) {
        if (err) {
    ...
    */
    ...
    fs.writeFile('./output/gds-vim/' + component.tabTrigger + '.snippets', vimSnippet, function(err) {
        if (err) {
            return console.log(err);
        }
    });
    ...
    */
    ...
    fs.writeFile('./output/gds-phpstorm/' + component.tabTrigger + '.xml', phpStormSnippet, function(err) {
        if (err) {
            return console.log(err);
        }
    });
